...
export async function advCashMngmnt() {
    ...
    try {
        ...
        expCategories = await ExpenseCategoriesModel.find();
    ...
    return { isBaseCurrency: isBaseCurrency, expCategories: expCategories, incCategories: incCategories, currencies: currencies, isoCode: isoCode, totalIncome: totalIncome, totalExpenses: totalExpenses };
}
